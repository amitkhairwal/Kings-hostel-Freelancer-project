      ...
      <div className="w-full max-w-4xl grid grid-cols-1 gap-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-500">
            Discover our Accommodation Services tile and experience the comfort
            and convenience of living at Kings Hostel/PG. Our meticulously
            designed rooms and amenities are tailored to ensure a hassle-free
            and comfortable living experience for students and working
            professionals alike. <br /> From spacious bedrooms to modern
            facilities, we provide everything you need to feel at home during
            your stay. Explore our accommodation options and find the perfect
            space to study, relax, and recharge in a vibrant and welcoming
            environment.
          </p>
        </div>
      </div>
